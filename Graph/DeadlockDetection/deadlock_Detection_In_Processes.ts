...
// Then you have to create a directed graph and find cycle in the directed graph.

// If you find cycle in directed graph then there is a deadlock in processes.